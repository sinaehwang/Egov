  ...
  <div class="column middle">
    ...
    <table align="center" width="100%" border="1" style="border-color:#333; border-spacing:0; border-collapse:collapse;" >
    	<tr>
    		...
    		<td width="50%" style="padding:5px;" align="center"><input name="title" type="text" size="90%" style="height:30px; font-size:15px;" placeholder=" 제목을 입력하세요."></td>
    	</tr>
    	<tr>
    		<td width="50%" align="center" style="overflow: hidden; background-color: #333; color: #f2f2f2; padding : 5px;">내용</td>
    		<td height="300px"style="padding:5px;" align="center"><input name="content" type="text" size="90%" style="height:300px; font-size:15px;" placeholder=" 내용을 입력하세요."></td>
    	</tr>
    	<tr>
    		<td width="50%" align="center" style="overflow: hidden; background-color: #333; color: #f2f2f2; padding : 5px;">비밀번호</td>
    		<td width="50%" style="padding:5px;" align="center"><input name="password" id="pw" onchange="check_pw()" type="text" size="90%" style="height:30px; font-size:15px;" placeholder=" 숫자 4자리 이상"></td>
    	</tr>
    	<tr>
    		<td width="50%" align="center" style="overflow: hidden; background-color: #333; color: #f2f2f2; padding : 5px;">비밀번호 확인</td>
    		<td width="50%" style="padding:5px;" align="center"><input name="pwConfirm" id="pw2" onchange="check_pw()" type="text" size="90%" style="height:30px; font-size:15px;">
    		<div></div>
    		<span id="check"></span>
    		</td>
    	</tr>    	
